...
- **Clean Eating**: tracked by exception — every day starts clean and costs zero taps; slips get logged against five trigger foods (Bread, Dairy, Fried, Soda, Alcohol). One free day per week forgives its slips. A separate clean streak sits beside the practice streak, and Trends shows a 30-day slip tally per food.
